...
import 'package:islami_app/presentation/modules/home_module/tabs/quran_tab/widgets/quran_header_widget.dart';
import 'package:islami_app/presentation/modules/home_module/tabs/quran_tab/widgets/sura_name_widget.dart';
    ...
    return Container(
      child: Column(
        children: [
          Expanded(
              flex: 1,
              child: Image.asset(assetsManager.quranHeader)),
          QuranWidget(),
          Expanded(
            flex: 2,
            child: ListView.separated(itemBuilder: (context,index)=> SuraNameWidget(SuraItem: suraItem(suraName: SuraNames[index], versesNumber: versesNumber[index].toString(),index: index),),
